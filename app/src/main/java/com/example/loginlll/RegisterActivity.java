...
public class RegisterActivity extends AppCompatActivity {
            ...
            public void onClick(View v)
            {
                ...
                if (TextUtils.isEmpty(txtUserName) || TextUtils.isEmpty(txtEmail) || TextUtils.isEmpty(txtPassword)
                    ...
                    if (selected_Gender == null) {
                        ...
                        registerNewAccount(txtUserId, txtUserName, txtEmail, txtPassword, txtMobile, selectGender);
                    }
                }
            }
        });
    ...
    private void registerNewAccount(final String userid, final String username, final String email, final String password,
